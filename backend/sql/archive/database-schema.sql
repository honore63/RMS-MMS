-- =====================================================
-- RMS DATABASE SCHEMA - RUN THIS COMPLETELY IN SUPABASE SQL EDITOR
-- =====================================================
...
-- =====================================================
-- DEFAULT DATA (safe with ON CONFLICT)
-- =====================================================

INSERT INTO grading_scales (minimum_percentage, maximum_percentage, grade, remark) VALUES
(80, 100, 'A', 'Excellent'),
(70, 79, 'B', 'Very Good'),
(60, 69, 'C', 'Good'),
...
VALUES ('Rukara Model School', 50, TRUE, FALSE)
ON CONFLICT DO NOTHING;
...
('Mathematics', 'MATH'), ('English', 'ENG'), ('Kinyarwanda', 'KIN'),
('Science and Elementary Technology', 'SET'), ('Social and Religious Studies', 'SRS'),
('Creative Arts', 'CA'), ('Physical Education', 'PE'), ('ICT', 'ICT')
ON CONFLICT DO NOTHING;
